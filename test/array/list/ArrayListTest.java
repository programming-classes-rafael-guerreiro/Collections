...
public class ArrayListTest {
	...
	@Test
	public void addAll_with_another_array_list_and_then_update_the_list() {
		ArrayList<String> list1 = new ArrayList<>();
		list1.addAll("a", "b", "c");
	...
	@Test
	public void insertAll_with_linked_list_should_move_2_elements_when_size_is_5_and_index_is_3() {
		ArrayList<String> list = new ArrayList<>(5);
		list.addAll("0", "1", "2", "3", "4");
	...
	@Test
	public void insertAll_with_linked_list_should_move_5_elements_when_size_is_5_and_index_is_0() {
		ArrayList<String> list = new ArrayList<>(5);
		list.addAll("0", "1", "2", "3", "4");
